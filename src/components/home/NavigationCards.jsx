...
import mapImg from '../../../public/assets/images/40c844a6d8c0175e2efc8e51862525a0f6d3b738.png';
import gamepadImg from '../../../public/assets/images/9d3de6e170511eb787a2293538a7cbbe522a9a47.png';
import star1Img from '../../../public/assets/images/ae69e4c1a95304346f40dfab04b13955e449874e.png';
import star2Img from '../../../public/assets/images/ef5653963edde4219363c59a1bcefcf4d5ea4c55.png';
import star3Img from '../../../public/assets/images/8c335b42af4f8ea1054507184808e84a73cc45f5.png';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="md:absolute md:left-[-10px] md:top-[-25px] w-[280px] md:w-[337px] h-auto flex-shrink-0 z-10 transition-transform group-hover:scale-105">
            <img src={mapImg} alt="Map of Indonesia" className="w-full h-full object-contain" />
          </div>
        ...
        >
          ...
          <div className="relative w-[200px] md:w-[240px] h-[180px] md:absolute md:right-[10px] md:top-[10px] z-10 transition-transform group-hover:scale-105">
            <img src={gamepadImg} alt="Gamepad" className="w-[141px] h-[141px] object-contain absolute right-4 md:right-8 top-4 md:top-2 shadow-sm rounded-lg" />
            <motion.img 
              animate={{ y: [0, -10, 0] }}
